...
<div id="rodape">
	...
	<div id="links-rodape-sobre">
		<h2>Sobre</h2>
			<ul>
				<li>
					<a href="about/contato.php#canvas">Quem somos</a>
				</li>
				<li>
